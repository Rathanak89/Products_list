              ...
              <div class="card-body px-5 py-5">
                ...
                <?php
                  if(isset($_POST['btnlogin'])) {
                    ...
                    $user_pwd=$conn->real_escape_string(trim($_POST['password']));
                    $user_pwd=md5($user_pwd);
                    if($user_name == "" && $user_pwd ==""){
                      echo msg_style('Please input User Name and Password','info');
                    }
                    else{
                      ...
                      if(mysqli_num_rows($result)>0){
                        ...
                        echo msg_style('wrong username or password','info');
                      }
                    }
                  }
                ?>
